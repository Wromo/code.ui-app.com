...
export function simplifyCodeuiappActions(input: string): string {
  // Using regex to match codeuiappAction tags that have type="file"
  const regex = /(<codeuiappAction[^>]*type="file"[^>]*>)([\s\S]*?)(<\/codeuiappAction>)/g;
